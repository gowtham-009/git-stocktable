<template>
  ...
  <div class="card">
     ...
     <Column class="cursor-pointer" v-if="visibleColumns.includes('quantity')" sortable field="quantity"header="No_of_Trades"  :showFilterOperator="false" :showFilterMatchModes="false">
       <template #body="{ data }">
     ...
     <Column class="cursor-pointer"  v-if="visibleColumns.includes('avgprice')"  sortable field="avgprice" header="Realizedpl"  :showFilterOperator="false" :showFilterMatchModes="false">
       <template #body="{ data }">
  ...
  const columns = ref([
  { field: 'stockname', header: 'Months' },
  { field: 'quantity', header: ' No of Trades' },
  { field: 'avgprice', header: 'Realizedpl' },
  { field: 'ltp', header: 'Net Realizedpl' },
